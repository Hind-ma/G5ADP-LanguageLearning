export const sentenceList = [
    ...
    {id:7, sentence:"Jag gillar _ mat, därför använder jag mycket svartpeppar ", answer:"stark"},
    {id:8, sentence:"Min favorit _ är glass ", answer:"efterrätt"},
    {id:9, sentence:"Kan jag få låna din _ min mobil har bara 10% ", answer:"laddare"},
    ...
    {id:17, sentence:"Här är mitt telefonnummer, du kan _ om du behöver hjälp ", answer:"ringa"},
    {id:18, sentence:"Vad är ditt favorit _? Min är häst", answer:"djur"},
    {id:19, sentence:"Hur många _ är den nya boken? Den gamla var 271 ", answer:"sidor"}
]
